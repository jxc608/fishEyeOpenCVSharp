...
namespace HID_Demo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            HIDDevice device = demo.useSynchronousOperation();
            while (true)
            {
    ...
    public class HID_demo
    {
        ...
        public HIDDevice useSynchronousOperation()
        {
            ...
            long SN = devices[selectedDeviceIndex].serialNumber;
            string devicePath = devices[selectedDeviceIndex].devicePath;
            Console.WriteLine(VID.ToString("X4"));
            ...
            Console.WriteLine(sb.ToString());
           // Console.WriteLine(System.Text.Encoding.Default.GetString(readData));
